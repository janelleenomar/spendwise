...
class EditExpenseScreen extends StatefulWidget {
  final Expense expense; // The existing expense object to edit
  final int expenseKey;  // The Hive box key for this specific expense
...
class _EditExpenseScreenState extends State<EditExpenseScreen> {
  ...
  void initState() {
    super.initState();
    // Pre-fill all fields with the existing expense data as soon as the screen loads
  ...
  Future<void> _update() async {
    ...
    // Call the update method from our Service layer
